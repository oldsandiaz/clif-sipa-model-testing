...
## Needed tables
true_tables <- list("clif_medication_admin_continuous", "clif_patient", "clif_hospitalization", "clif_adt", "clif_respiratory_support", "clif_labs", "clif_vitals", "clif_patient_assessments")
...
# Save to HTML file
save_html(table1_html, file = "table1.html")
```
